"""Compare matched runs allowing only an explicitly declared value-loss cap change."""
import argparse
import json
...
def main():
    ...
    parser.add_argument("--clips", nargs=2, type=float, required=True)
    ...
    result = paired_comparison(args.left, args.right, args.metric, value_clips=args.clips)
